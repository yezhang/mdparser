...
export default {
    atn, dfa, context, misc, tree, error, Token, TokenSource, CommonToken, CharStreams, CharStream, InputStream, CommonTokenFactory, CommonTokenStream, Lexer, Parser,
    ParserRuleContext, Interval, IntervalSet, LL1Analyzer, Utils, TokenStreamRewriter
}

export {
    Token, TokenSource, CommonToken, CharStreams, CharStream, InputStream, CommonTokenFactory, CommonTokenStream, Lexer, Parser,
